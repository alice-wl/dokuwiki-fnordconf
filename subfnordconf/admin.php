...
class admin_plugin_subfnordconf extends DokuWiki_Admin_Plugin {
	...
	$this->meta = DOKU_PLUGIN.'subfnordconf/conf/subfnordconf_metadata.php';
	$this->default = DOKU_PLUGIN.'subfnordconf/conf/subfnordconf_default.php';
	...
	if( isset( $_REQUEST['vhost']['vhost']) && preg_match( '/[a-z0-9_\-]/', $_REQUEST['vhost']['vhost'] )) {
		...
		$_config = &plugin_load( 'helper', 'subfnordconf_config' );
